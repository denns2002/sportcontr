...
import { Camera, LockKeyhole, LogOut, SlidersVertical } from 'lucide-react'
import { getUserAge, parseDate } from '@/lib/dates'
import Image from 'next/image'
import { ButtonLink } from '../../_components/components/custom/links'
import { DefaultButton } from '../../_components/components/custom/buttons'
		...
		<div className='h-full w-full flex flex-col gap-5 justify-center'>
			<div className='w-full max-w-screen-xl mx-auto flex flex-col gap-5'>
				...
				<div className='flex flex-row gap-10 flex-wrap gap-y-5'>
					<ButtonLink href='/demo/profile/edit'>
						<>
							<SlidersVertical className='h-5 w-5' />
							<span>Редактировать</span>
						</>
					</ButtonLink>
					<ButtonLink href='#' color='gray'>
						<>
