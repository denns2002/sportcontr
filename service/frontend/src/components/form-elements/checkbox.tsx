...
export function Checkbox({ label, id, value, ...attributes }: InputPorps) {
	...
	return (
		<div className='w-full flex flex-row gap-5 items-center'>
			...
			<div
				className='h-full cursor-pointer border-sky-500 border-2 rounded-lg hover:border-hover transition-all duration-300'
				onClick={() => setIsChecked((prev) => !prev)}
			>
				<div className={`bg-white p-1 ${isChecked ? 'text-black' : 'text-white'} shadow-md rounded-lg`}>
