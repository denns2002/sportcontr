...
import { z } from 'zod'
import { patchTrainersGroupDetailsService } from '@/data/services/groups-trainers'
...
export async function editTrainerGroupAction(slug: string, members: Array<number>, prevState: any, formData: FormData) {
	...
	const responseData = await patchTrainersGroupDetailsService(slug, {...validatedFields.data, members})
