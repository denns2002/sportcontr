...
export async function editNewsAction(slug: string, prevState: any, formData: FormData) {
	...
	if (image.name !== 'undefined' && image.size !== 0 && image.type !== 'application/octet-stream') {
